 ...
 */
JSDataSet.prototype.getAsHTML = function getAsHTML(escape_values, escape_spaces, allowMultiLine, useIndent, addColumnInformation) {
    let html = '';
...
JSDataSet.prototype.getColumnName = function getColumnName(index) { return (index >= 1 && index <= this.columns.length) ? this.columns[index - 1].name : null; };

JSDataSet.prototype.getColumnType = function getColumnType(index) { return (index >= 1 && index <= this.columns.length) ? this.columns[index - 1].type : null; };
...
JSDataSet.prototype.getMaxRowIndex = function getMaxRowIndex() { return this.rows.length; };

JSDataSet.prototype.getMaxColumnIndex = function getMaxColumnIndex() { return this.columns.length; };
