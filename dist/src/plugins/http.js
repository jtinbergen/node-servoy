...
exports.getPageData = exports.getMediaData = exports.createNewHttpClient = exports.HTTP_STATUS = void 0;
...
class HttpRequest {
    ...
    async executeRequest(username, password, workstation, domain) {
        return new Promise((resolve, reject) => {
            const client = this.options.tls || (this.options.protocol && this.options.protocol === 'https:')
                ? https
                : http;
            this.options.headers = this.options.headers || {};
            if (this.body) {
...
exports.createNewHttpClient = createNewHttpClient;
const getMediaData = () => { };
